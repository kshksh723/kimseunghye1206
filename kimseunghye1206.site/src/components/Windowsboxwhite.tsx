...
<div className="space-y-6">
 ...
 <li>
  ...
  <ul className="list-disc text-gray-800 space-y-2 text-sm leading-relaxed">
    ...
    <li>
      <strong>로직 분석 및 산출물 작성:</strong> 작업지시·실적 등록 등 핵심 화면과 PL/SQL 프로시저 간의 연계 로직 분석과 상태 흐름 검증 후 기술 산출물 작성 및 <strong>품질 감리 우수 평가(A+) 획득</strong>
    </li>
  </ul>
</ul>
  </div>
...
<div className="mb-8 mt-3 px-1 md:px-2">
  ...
  <span className="text-sm text-gray-500 tabular-nums">2025.09. ~ 진행중</span>
</div>
